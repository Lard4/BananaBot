# -*- coding: utf-8 -*-
"""Copy of Copy of Copy of bananabot.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1k0cl0JQGc3oOk8CvdjzaFfnJoY_bULnn

Download images and do imports
"""
...
for classNum in range(numClasses):
  ...
  for data in dataset["class"+str(classNum)]:
    ...
    fitted = ImageOps.fit(img, (square, square))
    augmented_class_set.append(flipped)
    augmented_class_set.append(mirrored)
    augmented_class_set.append(fitted)

    # increment counter
    index += 1
  
  # add dataset augmented
  dataset["class"+str(classNum)].extend(augmented_class_set)
...
"""Compute the mean intensity of the training data and subtract it from all images because neural networks train more effectively when data is centered."""
...
print("correct=" + str(correct) + " incorrect=" + str(incorrect) + " total=" + str(total) + " compostability accuracy=" + str(correct/total))
